...
public class Calibration {
    ...
    // LIFT
    public static final double LIFT_MAX_DISTANCE = 8490;
    ...
    public static final double X_SCALE = 0.013310328;
    public static final double Y_SCALE =  0.010912563;
    public static final double ROT_SCALE = 0.027147274;
    public static final double X_TOP_SPEED = 0.12; // 0.35?
    ...
    public static final double EXTENDER_POT_MAX = 0;
    public static final double EXTENDER_POT_MIN = 0;
}
